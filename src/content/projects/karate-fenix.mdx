...
excerpt: A platform for a karate school where students can learn and practice karate techniques. The project includes a video learning platform, and some informational about the school.
...
The second phase is to add two more sections to the website: a blog and a classes page.

The blog will be used to share news and articles about karate. I will use [Directus](https://directus.io/) as a headless CMS to manage the blog content.

The other page I want to add is a page to display information about the classes. This page will include a list of classes and the schedule. I am still thinking about the design and the features of this page. I want to display like a weekly calendar with the information but I don't have a clear idea yet.
...
- [Directus](https://directus.io/) for the headless CMS. I needed an easy to use CMS for the instructors to manage the data. I wanted to use an already built CMS instead of building my own because I didn't want to spend a lot of time on this. I needed something that I could connect to Supabase and Directus was the best option. Right now I am self hosting it on render but I am looking for another option that offers a generous. I am under the free plan right now on Render but it's very slow. I don't want to pay to host the CMS as it's just gonna be used by a few people.
